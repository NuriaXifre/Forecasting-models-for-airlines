...
print(Exponential_forecast_Average_rate_of_growth (Terminal_passengers,Anual_change,time,terminal_passengers,n))
print(Exponential_forecast_Moving_average_growth (Terminal_passengers,Anual_change,time,terminal_passengers,n))
print(Exponential_forecast_Exponential_Smoothing(terminal_passengers,Anual_change,alpha,n))
print(Linear_forecast_Average_rate_of_growth (Years,terminal_passengers,years,time,n))
print(Linear_forecast_Average_rate_of_growth_Moving_Average (Years,Terminal_passengers,terminal_passengers,years,time,n))
print(Gravity_model_original (K,P_i,P_j,D_ij))
print(Gravity_model_Doganis (K,A_i,A_j,P,D_ij))
print(Gravity_models_complex (K,A_i_sc,A_j_sc,Q,F))
print(Causal_method())